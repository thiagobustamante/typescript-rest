...
var BadRequestError = (function (_super) {
    ...
    function BadRequestError(message) {
        _super.call(this, "BadRequestError", 400, message);
    }
...
var UnauthorizedError = (function (_super) {
    ...
    function UnauthorizedError(message) {
        _super.call(this, "UnauthorizedError", 401, message);
    }
...
var ForbidenError = (function (_super) {
    ...
    function ForbidenError(message) {
        _super.call(this, "ForbidenError", 403, message);
    }
...
var NotFoundError = (function (_super) {
    ...
    function NotFoundError(message) {
        _super.call(this, "NotFoundError", 404, message);
    }
...
var MethodNotAllowedError = (function (_super) {
    ...
    function MethodNotAllowedError(message) {
        _super.call(this, "MethodNotAllowedError", 405, message);
    }
...
var NotAcceptableError = (function (_super) {
    ...
    function NotAcceptableError(message) {
        _super.call(this, "NotAcceptableError", 406, message);
    }
...
var ConflictError = (function (_super) {
    ...
    function ConflictError(message) {
        _super.call(this, "ConflictError", 409, message);
    }
...
var GoneError = (function (_super) {
    ...
    function GoneError(message) {
        _super.call(this, "GoneError", 410, message);
    }
    return GoneError;
}(server_types_1.HttpError));
...
var UnsupportedMediaTypeError = (function (_super) {
    ...
    function UnsupportedMediaTypeError(message) {
        _super.call(this, "GoneError", 415, message);
    }
...
var InternalServerError = (function (_super) {
    ...
    function InternalServerError(message) {
        _super.call(this, "InternalServerError", 500, message);
    }
...
var NotImplementedError = (function (_super) {
    ...
    function NotImplementedError(message) {
        _super.call(this, "NotImplementedError", 501, message);
    }
